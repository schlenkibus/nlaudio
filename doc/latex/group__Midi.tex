...
void \hyperlink{group__Midi_gaf9dfa04b59e579eb3e4a24c8979bdc57}{Nl\-::\-Raw\-Midi\-Device\-::set\-Alsa\-Midi\-Buffer\-Size} (unsigned int size)
\begin{DoxyCompactList}\small\item\em Set Alsa's midi buffer size. \end{DoxyCompactList}\item 
unsigned int \hyperlink{group__Midi_gad34ca9297599d1dc8113fded930263ce}{Nl\-::\-Raw\-Midi\-Device\-::get\-Alsa\-Midi\-Buffer\-Size} ()
\begin{DoxyCompactList}\small\item\em Get Alsa's midi buffer size. \end{DoxyCompactList}\item 
...
static std\-::string \hyperlink{group__Midi_ga9c95def97d341828fa23d3bf1a0b3c29}{Nl\-::\-Raw\-Midi\-Device\-::get\-First\-Device} ()
\begin{DoxyCompactList}\small\item\em Static function that returns first available alsa midi device. \end{DoxyCompactList}\item 
\hyperlink{group__Midi_ga79b838431bf9ea9f8666684c38c036f7}{Nl\-::\-Raw\-Midi\-Device\-Exception\-::\-Raw\-Midi\-Device\-Exception} (int error\-Number, std\-::string what)
\begin{DoxyCompactList}\small\item\em Constructor. \end{DoxyCompactList}\item 
virtual const char $\ast$ \hyperlink{group__Midi_gaf6539bbb6e2285a3fa1b115e5b43fc13}{Nl\-::\-Raw\-Midi\-Device\-Exception\-::what} () const noexcept
...
\hypertarget{group__Midi_gad34ca9297599d1dc8113fded930263ce}{\index{Midi@{Midi}!get\-Alsa\-Midi\-Buffer\-Size@{get\-Alsa\-Midi\-Buffer\-Size}}
\index{get\-Alsa\-Midi\-Buffer\-Size@{get\-Alsa\-Midi\-Buffer\-Size}!Midi@{Midi}}
\subsubsection[{get\-Alsa\-Midi\-Buffer\-Size}]{\setlength{\rightskip}{0pt plus 5cm}unsigned int Nl\-::\-Raw\-Midi\-Device\-::get\-Alsa\-Midi\-Buffer\-Size (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{group__Midi_gad34ca9297599d1dc8113fded930263ce}


Get Alsa's midi buffer size. 

\begin{DoxyReturn}{Returns}
Current size of alsas internal midi buffer
\end{DoxyReturn}
Returns the size of alsas current internal midi buffer. See also\-:\par
\hyperlink{group__Midi_gaf9dfa04b59e579eb3e4a24c8979bdc57}{set\-Alsa\-Midi\-Buffer\-Size()} \hypertarget{group__Midi_gaf6f05ac177aed9d05e06f34a776b5317}{\index{Midi@{Midi}!get\-Available\-Devices@{get\-Available\-Devices}}
...
\end{DoxyReturn}
Lists all available midi devices \hypertarget{group__Midi_ga9c95def97d341828fa23d3bf1a0b3c29}{\index{Midi@{Midi}!get\-First\-Device@{get\-First\-Device}}
\index{get\-First\-Device@{get\-First\-Device}!Midi@{Midi}}
\subsubsection[{get\-First\-Device}]{\setlength{\rightskip}{0pt plus 5cm}std\-::string Nl\-::\-Raw\-Midi\-Device\-::get\-First\-Device (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{group__Midi_ga9c95def97d341828fa23d3bf1a0b3c29}
...
\end{DoxyCode}
 \hypertarget{group__Midi_ga8be460b3e5b9b06cb21d1b47f7f488ab}{\index{Midi@{Midi}!Raw\-Midi\-Device@{Raw\-Midi\-Device}}
...
\end{DoxyParamCaption}
)}}\label{group__Midi_ga8be460b3e5b9b06cb21d1b47f7f488ab}
...
\hline
\end{DoxyParams}
Constructor for \hyperlink{classNl_1_1RawMidiDevice}{Raw\-Midi\-Device} \hypertarget{group__Midi_ga79b838431bf9ea9f8666684c38c036f7}{\index{Midi@{Midi}!Raw\-Midi\-Device\-Exception@{Raw\-Midi\-Device\-Exception}}
\index{Raw\-Midi\-Device\-Exception@{Raw\-Midi\-Device\-Exception}!Midi@{Midi}}
\subsubsection[{Raw\-Midi\-Device\-Exception}]{\setlength{\rightskip}{0pt plus 5cm}Nl\-::\-Raw\-Midi\-Device\-Exception\-::\-Raw\-Midi\-Device\-Exception (
\begin{DoxyParamCaption}
\item[{int}]{error\-Number, }
\item[{std\-::string}]{what}
\end{DoxyParamCaption}
)}}\label{group__Midi_ga79b838431bf9ea9f8666684c38c036f7}
...
\hline
\end{DoxyParams}
\hypertarget{group__Midi_gaf9dfa04b59e579eb3e4a24c8979bdc57}{\index{Midi@{Midi}!set\-Alsa\-Midi\-Buffer\-Size@{set\-Alsa\-Midi\-Buffer\-Size}}
\index{set\-Alsa\-Midi\-Buffer\-Size@{set\-Alsa\-Midi\-Buffer\-Size}!Midi@{Midi}}
\subsubsection[{set\-Alsa\-Midi\-Buffer\-Size}]{\setlength{\rightskip}{0pt plus 5cm}void Nl\-::\-Raw\-Midi\-Device\-::set\-Alsa\-Midi\-Buffer\-Size (
\begin{DoxyParamCaption}
\item[{unsigned int}]{size}
\end{DoxyParamCaption}
)}}\label{group__Midi_gaf9dfa04b59e579eb3e4a24c8979bdc57}


Set Alsa's midi buffer size. 


\begin{DoxyParams}{Parameters}
{\em size} & Buffersize in bytes\\
\hline
\end{DoxyParams}
If you set size to 3, you will get every midi message immediately, since a midi message has 3 bytes. Setting it to lower values will add overhead, but no real advantage. Setting it to a bigger value delays the delivery of the values until this value is reached. \hypertarget{group__Midi_ga9ca4e486b5df388d9000ea8ef48d31a8}{\index{Midi@{Midi}!start@{start}}
...
This starts the worker thread on the interface and has to be called, in order to use the interface. 
...
This stops the worker thread on the interface and should be called, before closing the application. 

Implements \hyperlink{classNl_1_1Midi}{Nl\-::\-Midi}.

\hypertarget{group__Midi_gaf6539bbb6e2285a3fa1b115e5b43fc13}{\index{Midi@{Midi}!what@{what}}
\index{what@{what}!Midi@{Midi}}
\subsubsection[{what}]{\setlength{\rightskip}{0pt plus 5cm}const char $\ast$ Nl\-::\-Raw\-Midi\-Device\-Exception\-::what (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [virtual]}, {\ttfamily [noexcept]}}}\label{group__Midi_gaf6539bbb6e2285a3fa1b115e5b43fc13}
...
\end{DoxyReturn}
\hypertarget{group__Midi_ga8ede83b60ff88f34a597952ea1bd32fb}{\index{Midi@{Midi}!$\sim$\-Raw\-Midi\-Device@{$\sim$\-Raw\-Midi\-Device}}
\index{$\sim$\-Raw\-Midi\-Device@{$\sim$\-Raw\-Midi\-Device}!Midi@{Midi}}

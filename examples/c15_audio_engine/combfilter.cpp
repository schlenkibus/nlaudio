...
void CombFilter::calcLowpassFreq()
{
    ...
    float stateVar_r = NlToolbox::Math::sinP3_wrap(tmpVar);
    float stateVar_i = NlToolbox::Math::sinP3_wrap(tmpVar + 0.25f);
...
//    float omegaCos = NlToolbox::Math::cos(tmpVar);
    ...
    float stateVar1_i = NlToolbox::Math::sinP3_wrap(tmpVar) * -1.f * mAllpassCoeff_1;
    float stateVar2_i = NlToolbox::Math::sinP3_wrap(tmpVar + tmpVar);
    float stateVar1_r = NlToolbox::Math::sinP3_wrap(tmpVar + 0.25f) * mAllpassCoeff_1;
    float stateVar2_r = NlToolbox::Math::sinP3_wrap(tmpVar + tmpVar + 0.25f);

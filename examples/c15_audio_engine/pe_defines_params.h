...
const float param_definition[sig_number_of_params][10] = {
    ...
    {        63,     3,      0,      8000,   0,      0,      7,      1,      1,      8000   },         // 52  OSC_A_PM_SELF_SHAPER
    {        64,     2,      0,      8000,   4,      1,      -1,     0,      1,      8000   },         // 53  OSC_A_PM_B
    {        66,     3,      0,      16000,  0,      0,      -1,     0,      0,      16000  },         // 54  OSC_A_PM_B_ENV_B
    {        67,     3,      0,      8000,   0,      0,      9,      1,      1,      8000   },         // 55  OSC_A_PM_B_SHAPER
    ...
    {        74,     3,      0,      16000,  0,      0,      13,     1,      0,      16000  },         // 61  SHP_A_FOLD
    {        75,     3,      0,      16000,  0,      0,      14,     1,      0,      16000  },         // 62  SHP_A_ASYMETRY
    {        76,     2,      0,      8000,   0,      0,      15,     1,      1,      8000   },         // 63  SHP_A_MIX
    {        78,     2,      0,      16000,  5,      0,      16,     1,      0,      16000  },         // 64  SHP_A_FEEDBACK_MIX
    {        80,     3,      0,      16000,  0,      0,      -1,     1,      0,      16000  },         // 65  SHP_A_FEEDBACK_ENV_C
    {        81,     2,      0,      16000,  0,      0,      18,     1,      0,      16000  },         // 66  SHP_A_RINGMOD
    ...
    {        93,     3,      0,      8000,   0,      0,      22,     1,      1,      8000   },         // 74  OSC_B_PM_SELF_SHAPER
    {        94,     2,      0,      8000,   4,      1,      -1,     0,      1,      8000   },         // 75  OSC_B_PM_A
    {        96,     3,      0,      16000,  0,      0,      -1,     0,      0,      16000  },         // 76  OSC_B_PM_A_ENV_A
    {        97,     3,      0,      8000,   0,      0,      24,     1,      1,      8000   },         // 77  OSC_B_PM_A_SHAPER
    ...
    {        104,    3,      0,      16000,  0,      0,      28,     1,      0,      16000  },         // 83  SHP_B_FOLD
    {        105,    3,      0,      16000,  0,      0,      29,     1,      0,      16000  },         // 84  SHP_B_ASYMETRY
    {        106,    2,      0,      8000,   0,      0,      30,     1,      1,      8000   },         // 85  SHP_B_MIX
    {        108,    2,      0,      16000,  5,      0,      31,     1,      0,      16000  },         // 86  SHP_B_FEEDBACK_MIX
    {        110,    3,      0,      16000,  0,      0,      -1,     1,      0,      16000  },         // 87  SHP_B_FEEDBACK_ENV_C
    {        111,    2,      0,      16000,  0,      0,      33,     1,      0,      16000  },         // 88  SHP_B_RINGMOD

    // - - - COMB FILTER - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        113,    2,      0,      16000,  6,      1,      34,     1,      0,      16000  },         // 89  CMB_AB
    ...
    {        127,    3,      0,      16000,  0,      0,      40,     1,      0,      16000  },         // 99  CMB_ALLPASS_RESON
    ...
    {        133,    3,      0,      8000,   4,      0.9,    42,     1,      1,      8000   },         // 103 CMB_PM
    {        135,    3,      0,      16000,  2,      1,      43,     1,      0,      16000  },         // 104 CMB_PM_AB

    // - - - STATE VARIABLE FILTER  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 105 SVF_AB
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 106 SVF_COMB_MIX
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 107 SVF_CUTOFF
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 108 SVF_CUTOFF_KT
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 109 SVF_CUTOFF_ENV_C
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 110 SVF_SPREAD
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 111 SVF_FM
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 112 SVF_RESONANCE
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 113 SVF_RESONANCE_KT
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 114 SVF_RESONANCE_ENV_C
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 115 SVF_LBH
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 116 SVF_PARALLEL
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 117 SVF_FM_AB
    ...
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 124 OUT_SVF_LEVEL
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 125 OUT_SVF_PAN
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 126 OUT_DRIVE
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 127 OUT_FOLD
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 128 OUT_ASYMETRY
    {        -1,     0,      0,      1,      0,      0,      -1,     0,      0,      0      },         // 129 OUT_LEVEL

    // - - - MASTER - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        247,    2,      0,      16000,  4,      4,      71,     0,      0,      16000  },         // 130 MASTER_VOLUME
    ...
    {        407,    0,      1,      16000,  0,      0.5,    -1,     0,      0,      16000  },         // 135 KEY_VOICE_PAN

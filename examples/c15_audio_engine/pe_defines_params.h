...
const float param_definition[sig_number_of_params][10] = {
    ...
    // - - - OUTPUT MIXER - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        169,    2,      0,      4000,   0,      0,      -1,     0,      1,      8000   },         // 105 OUT_A_LEVEL
    {        171,    2,      0,      16000,  0,      0.5,    -1,     0,      1,      8000   },         // 106 OUT_A_PAN
    {        172,    2,      0,      4000,   0,      0,      -1,     0,      1,      8000   },         // 107 OUT_B_LEVEL
    {        174,    2,      0,      16000,  0,      0.5,    -1,     0,      1,      8000   },         // 108 OUT_B_PAN
    {        175,    2,      0,      4000,   0,      0,      -1,     0,      1,      8000   },         // 109 COMB_LEVEL
    {        177,    2,      0,      16000,  0,      0.5,    -1,     0,      1,      8000   },         // 110 COMB_PAN

    // - - - MASTER - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        247,    2,      0,      16000,  4,      4,      50,     0,      0,      16000  },         // 111 MASTER_VOLUME
    {        248,    3,      0,      100,    0,      0,      -1,     0,      1,      4800   },         // 112 MASTER_TUNE

    // - - - POLY KEY EVENT - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        400,    0,      1,      14400,  0,      0,      -1,     0,      1,      7200   },         // 113 KEY_PHASE_A
    {        401,    0,      1,      14400,  0,      0,      -1,     0,      1,      7200   },         // 114 KEY_PHASE_B
    {        406,    0,      1,      1000,   0,      0,      -1,     0,      1,      1000   },         // 115 KEY_NOTE_PITCH
    {        407,    0,      1,      16000,  0,      0.5,    -1,     0,      0,      16000  },         // 116 KEY_VOICE_PAN
    {        408,    0,      1,      16000,  0,      0,      -1,     0,      0,      16000  },         // 117 KEY_ENV_C_RATE
    {        409,    0,      1,      1,      0,      0,      -1,     0,      0,      1      }          // 118 KEY_VOICE_STEAL

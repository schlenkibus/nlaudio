...
const float param_definition[sig_number_of_params][10] = {
    ...
    {        64,     2,      0,      8000,   4,      0.5,    -1,     0,      1,      8000   },         // 47  OSC_A_PM_B
    ...
    // - - - SHAPER A - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        71,     2,      0,      10000,  10,     0.18,   -1,     0,      0,      10000  },         // 53  SHP_A_DRIVE
    ...
    {        80,     3,      0,      16000,  0,      0,      17,     1,      0,      16000  },         // 59  SHP_A_FEEDBACK_ENV_C
    ...
    {        94,     2,      0,      8000,   4,      0.5,    -1,     0,      1,      8000   },         // 69  OSC_B_PM_A
    ...
    // - - - SHAPER B - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        101,    2,      0,      10000,  10,     0.18,   -1,     0,      0,      10000  },         // 75  SHP_B_DRIVE
    ...
    {        110,    3,      0,      16000,  0,      0,      32,     1,      0,      16000  },         // 81  SHP_B_FEEDBACK_ENV_C
    {        111,    2,      0,      16000,  0,      0,      33,     1,      0,      16000  },         // 82  SHP_B_RINGMOD

    // - - - OUTPUT MIXER - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        169,    2,      0,      4000,   0,      0,      -1,     0,      1,      8000   },         // 83  OUT_A_LEVEL
    {        171,    2,      0,      16000,  0,      0.5,    -1,     0,      0,      16000  },         // 84  OUT_A_PAN
    {        172,    2,      0,      4000,   0,      0,      -1,     0,      1,      8000   },         // 85  OUT_B_LEVEL
    {        174,    2,      0,      16000,  0,      0.5,    -1,     0,      0,      16000  },         // 86  OUT_B_PAN

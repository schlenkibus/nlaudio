...
const float param_definition[sig_number_of_params][10] = {
    ...
    // - - - COMB FILTER - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        113,    2,      0,      16000,  6,      1,      34,     1,      0,      16000  },         // 83  CMB_AB
    {        115,    3,      0,      100,    9,      0,      -1,     0,      0,      12000  },         // 84  CMB_PITCH
    {        117,    3,      0,      10000,  0,      0,      -1,     0,      0,      10500  },         // 85  CMB_PITCH_KT
    {        118,    3,      0,      100,    0,      0,      -1,     0,      1,      8000   },         // 86  CMB_PITCH_ENV_C
    {        119,    3,      0,      80,     0,      0,      -1,     0,      1,      8000   },         // 87  CMB_DECAY
    {        121,    3,      0,      16000,  0,      0,      -1,     0,      0,      16000  },         // 88  CMB_DECAY_KT
    {        305,    3,      0,      16000,  0,      0,      -1,     0,      0,      16000  },         // 89  CMB_DECAY_GATE
    {        123,    3,      0,      100,    9,      0,      -1,     0,      0,      14000  },         // 90  CMB_ALLPASS_TUNE
    {        125,    3,      0,      16000,  0,      0,      -1,     0,      0,      16000  },         // 91  CMB_ALLPASS_KT
    {        126,    3,      0,      100,    0,      0,      -1,     0,      1,      8000   },         // 92  CMB_ALLPASS_ENV_C
    {        127,    3,      0,      16000,  0,      0,      40,     1,      0,      16000  },         // 93  CMB_ALLPASS_RESON
    {        129,    3,      0,      100,    9,      40,     -1,     0,      0,      10000  },         // 94  CMB_HICUT
    {        131,    3,      0,      16000,  0,      0,      -1,     0,      0,      16000  },         // 95  CMB_HICUT_KT
    {        132,    3,      0,      80,     0,      0,      -1,     0,      1,      8000   },         // 96  CMB_HICUT_ENV_C
    {        133,    3,      0,      8000,   4,      0.9,    42,     1,      1,      8000   },         // 97  CMB_PM
    {        135,    3,      0,      16000,  2,      1,      43,     1,      0,      16000  },         // 98  CMB_PM_AB

    // - - - OUTPUT MIXER - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        169,    2,      0,      4000,   0,      0,      -1,     0,      1,      8000   },         // 99  OUT_A_LEVEL
    {        171,    2,      0,      16000,  0,      0.5,    -1,     0,      1,      8000   },         // 100 OUT_A_PAN
    {        172,    2,      0,      4000,   0,      0,      -1,     0,      1,      8000   },         // 101 OUT_B_LEVEL
    {        174,    2,      0,      16000,  0,      0.5,    -1,     0,      1,      8000   },         // 102 OUT_B_PAN
    {        175,    2,      0,      4000,   0,      0,      -1,     0,      1,      8000   },         // 103 COMB_LEVEL
    {        177,    2,      0,      16000,  0,      0.5,    -1,     0,      1,      8000   },         // 104 COMB_PAN

    // - - - MASTER - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        247,    2,      0,      16000,  4,      4,      50,     0,      0,      16000  },         // 105 MASTER_VOLUME
    {        248,    3,      0,      100,    0,      0,      -1,     0,      1,      4800   },         // 106 MASTER_TUNE

    // - - - POLY KEY EVENT - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //       ID      CLOCK   POLY    RANGE   SCALE   (ARG)   POST    SPREAD  POL     FACTOR
    {        400,    0,      1,      14400,  0,      0,      -1,     0,      1,      7200   },         // 107 KEY_PHASE_A
    {        401,    0,      1,      14400,  0,      0,      -1,     0,      1,      7200   },         // 108 KEY_PHASE_B
    {        406,    0,      1,      1000,   0,      0,      -1,     0,      1,      1000   },         // 109 KEY_NOTE_PITCH
    {        407,    0,      1,      16000,  0,      0.5,    -1,     0,      0,      16000  },         // 110 KEY_VOICE_PAN
    {        408,    0,      1,      16000,  0,      0,      -1,     0,      0,      16000  },         // 111 KEY_ENV_C_RATE
    {        409,    0,      1,      1,      0,      0,      -1,     0,      0,      1      }          // 112 KEY_VOICE_STEAL
